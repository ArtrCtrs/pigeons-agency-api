...
export class PigeonsService {
    ...
    static async addPigeon(user: User, expeditiontype: number) {
    ...
    //     const text = "UPDATE USERS SET totaldroppingsminute = $1,birds=$2  WHERE id =$3;";
    //     await pool.query(text, [user.totaldroppingsminute + droppings, user.birds + 1, user.id]);
    // }
