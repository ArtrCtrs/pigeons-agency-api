...
async function initDB() {
    ...
    text = 'CREATE TABLE IF NOT EXISTS PIGEONS (id SERIAL, type int NOT NULL,name varchar(255), rank int DEFAULT 1,attack int DEFAULT 1, shield int DEFAULT 1,defense int DEFAULT 3,energy int,element int default 0, droppingsminute int DEFAULT 2,feathers int DEFAULT 2,creationtime bigint, ownerid int REFERENCES USERS(id),PRIMARY KEY (id));'
    res = await pool.query(text);
